...
namespace Harmony.Injection
{
    ...
    /// </summary>
    /// <remarks>
    /// Un IInjectionContext n'est pas nécessairement la seule source de dépendances. Parfois, l'objet où il y a injection
    ...
    {
        /// <summary>
        /// Liste des fabriques de wrappers de dépendances pour ce IInjectionContext. Les fabriques de wrappers peuvent créer 
        ...
        /// <summary>
        /// Liste des objets statiques pour ce IInjectionContext.
        /// </summary>
        [NotNull]
        IEnumerable<object> StaticComponents { get; }

        /// <summary>
        /// Retourne tous les GameObject ayant le Tag spécifié dans ce IInjectionContext.
        /// </summary>
