...
{
    public class Torus : GameScript
    {
        [SerializeField] private TorusInfo torusInfo;
        ...
        public void Create()
        {
            ...
            float radius2 = torusInfo.Radius2;
            int nbRadSeg = torusInfo.NumberRadSeg;
            int nbSides = torusInfo.NumberSide;
